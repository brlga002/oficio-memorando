<?php $v->layout("dash::_theme"); ?>
    ...
    <h2>Modelo: <?= $modelo->nomeModelo ?></h2>
    ...
    <form class="user" action="<?= $action; ?>" method="post">
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                ...
                <input type="date" class="form-control" name="dataDoc" value="<?= ($modelo->dataDoc !== NULL) ? $modelo->dataDoc : date("Y-m-d") ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea  class="form-control" id="editor1" name="conteudoDoc" placeholder="Conteúdo" rows="12"><?= $modelo->conteudoDoc ?></textarea>
        </div>
