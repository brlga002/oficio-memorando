...
<form class="user" action="<?= url("documento/{$action}"); ?>" method="post">
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            ...
            <input type="date" class="form-control" name="dataDoc" value="<?= ($documento->dataDoc !== NULL) ? $documento->dataDoc : date("Y-m-d") ?>" required>
        </div>
        <div class="col-sm-12 mb-12 mb-sm-0">
            <label for="assuntoDoc">Assunto</label>
            <input type="text" class="form-control" name="assuntoDoc" placeholder="Assunto" value="<?= $documento->assuntoDoc ?>" required>
        </div>
    </div>
    <div class="form-group">
        <label for="destinatarioDoc">Destinatario</label>
        <textarea  class="form-control" name="destinatarioDoc" placeholder="Destinatário" rows="4" required><?= $documento->destinatarioDoc ?></textarea>
    </div>
    <div class="form-group">
        <label for="conteudoDoc">Conteúdo</label>
        <textarea  class="form-control" name="conteudoDoc" id="editor1" placeholder="Conteúdo" rows="12" required><?= $documento->conteudoDoc ?></textarea>
    </div>
