...
<form class="user" action="<?= $action; ?>" method="post">
    <div class="form-group row">
        <div class="col-sm-4 mb-3 mb-sm-0">
            ...
            <input type="text" class="form-control" name="nome" placeholder="Nome completo" value="<?= $data->nome ?>" required>
        </div>
        <div class="col-sm-4 mb-3 mb-sm-0">
            <label for="cargo">Nick</label>
            <input type="text" class="form-control" name="nick" placeholder="Primeiro nome" value="<?= $data->nick ?>" required>
        </div>
        <div class="col-sm-4 mb-3 mb-sm-0">
