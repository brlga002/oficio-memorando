...
<header>
    ...
    <div class="container">
        <div class="memo-numero">
            <?= $tipoDoc->tipo; ?> Nº <?= $memo->numeroDoc ?>/<?= $memo->anoDoc ?>/<?= $tipoDoc->sigla; ?>
        </div>
    ...
    <footer>
            ...
            CEP: 69054-739 Manaus/ AM - https://www.crtr19.gov.br E-mail: crtr19regiao@gmail.com
    </footer>


    <div class="qrcode-text">
        A autenticidade deste documento pode ser verificada em: <?= url("verifica/documento/{$memo->id}") ?> com a chave: <?= $memo->chave ?>
    </div>
    <div class="qrcode">
        <img src="<?= $urlqrCode ?>" />
    </div>
